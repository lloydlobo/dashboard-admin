...
export type LinkType = { id: number; text: string; url: string; alt: string };
export type IconType = { id: number; svg: string; alt: string };
export type EachLinkType = { icon: IconType; link: LinkType };
